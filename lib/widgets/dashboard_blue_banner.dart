                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    BalanceCard(
                      ...
                      dataBalance: Strings.REMAINING_DATA,
                      totalBalance: Strings.TOTAL_DATA,
                    ),
                    BalanceCard(
                        balance: Strings.LOAD_BALANCE,
                        dataBalance: Strings.PACKAGE_PRICE,
                        totalBalance: Strings.VALID_TILL),
                    BalanceCard(
                        balance: Strings.DATA_BALANCE,
                        dataBalance: Strings.REMAINING_DATA,
                        totalBalance: Strings.TOTAL_DATA),
                  ...
                  children: [
                    Padding(
                      padding: EdgeInsets.only(
                          top: 53.0, bottom: 13.0, left: 8.0, right: 24.0),
                      child: Row(
                      ...
                      child: ListView(
                        ...
                        children: [
                          ...
                          RecommendedPlansCard(
                            planName: Strings.RECOMMENDED_PLAN,
                            planValidity: Strings.PLAN_VALIDITY,
                          ),
                          RecommendedPlansCard(
                            planName: Strings.GLOBE_PLAN,
                            planValidity: Strings.GLOBE_VALIDITY,
                          ),
                          RecommendedPlansCard(
                            planName: Strings.RECOMMENDED_PLAN,
                            planValidity: Strings.PLAN_VALIDITY,
